        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('pengaduan') ? 'active' : '' }}" >
                <a href="{{ route('pengaduan.index') }}" class="menu-link" style="color: green;">
            ...
            @if (Auth::guard('petugas')->user())
                <li class="menu-item {{ request()->is('petugas/pengaduan') ? 'active' : '' }}">
                    <a href="{{ route('pengaduan.indexPetugas') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                    <div data-i18n="Pengaduan">Pengaduan</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->is('tanggapan') ? 'active' : '' }}">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('assets/template/assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
